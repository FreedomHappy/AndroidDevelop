...
public class NoteEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mText = (EditText) findViewById(R.id.note_edt);
    ...
    protected void onResume(){
        ...
        if (mCursor != null) {
            ...
            if (mState == STATE_EDIT) {
                ...
                int colTitleIndex = mCursor.getColumnIndex(TickNote.COLUMN_NAME_TITLE);
            ...
            int colNoteIndex = mCursor.getColumnIndex(TickNote.COLUMN_NAME_CONTENT);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.note_edit_options_menu, menu);
        return true;
    }
    @Override
...
//BEGIN_INCLUDE(paste)
    ...
    private final void performPaste() {
        ...
        if (clip != null) {
            ...
            if (uri != null && TickNote.CONTENT_ITEM_TYPE.equals(cr.getType(uri))) {
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        if (mState == STATE_INSERT) {
            ...
            values.put(TickNote.COLUMN_NAME_TITLE, title);
        } else if (title != null) {
            // In the values map, sets the value of the title
            values.put(TickNote.COLUMN_NAME_TITLE, title);
        }
        ...
        values.put(TickNote.COLUMN_NAME_CONTENT, text);
    ...
    private final void cancelNote() {
        if (mCursor != null) {
            if (mState == STATE_EDIT) {
                ...
                mCursor = null;
                ContentValues values = new ContentValues();
                values.put(TickNote.COLUMN_NAME_CONTENT, mOriginalContent);
