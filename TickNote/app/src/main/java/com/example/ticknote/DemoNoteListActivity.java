...
public class DemoNoteListActivity extends Activity implements OnScrollListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.demo_notelist);
        ...
        addNote.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                DemoNoteEdit.ENTER_STATE = 0;
                Intent intent = new Intent(mContext, DemoNoteEdit.class);
    ...
    public void RefreshNotesList() {
        ...
        simp_adapter = new SimpleAdapter(this, getData(), R.layout.demo_note_item,
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        while (c.moveToNext()) {
            ...
            DemoNoteEdit.id = Integer.parseInt(No);
            myIntent.putExtras(bundle);
            myIntent.setClass(this, DemoNoteEdit.class);
